...
$VueFactory.businessGrid({
   ...
   GridOptions: {
      ...
      columns: [
         ...
         {
            title: LoaderDict.Business.T_Device.RemoteCode, //远程编码
            width: 80,
            className: "text-center",
            data: "RemoteCode"
         },
         ...
         {
            title: LoaderDict.Business.T_DeviceZone.LastDataTime, //最后数据时间
            width: 80,
            className: "text-center",
            data: "LastDataTime"
         },
         {
            title: LoaderDict.Business.T_DeviceZone.FinalConnectTime, //最后连接时间
            width: 80,
            className: "text-center",
            data: "ConnectTime"
         },
