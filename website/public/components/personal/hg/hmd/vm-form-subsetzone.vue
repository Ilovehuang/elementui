<template>
   <div >
      ...
      <vx-container-item :label="LoaderDict.Business.T_Device.DeviceCode" :rule="Rules.DeviceCode">
         <vx-form-input :disabled="true" v-model="FormData.DeviceCode" :placeholder="LoaderDict.Placeholder.PleaseInput + LoaderDict.Business.T_Device.DeviceCode"></vx-form-input>
      </vx-container-item>
