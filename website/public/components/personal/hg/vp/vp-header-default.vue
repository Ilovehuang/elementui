<template>
   <div>
               ...
               <el-dropdown trigger="click" class="fr mr" @command="handleCommand">
                  ...
                  <el-dropdown-menu slot="dropdown">
                     <el-dropdown-item command="a">
                        <i class="fa fa-key" style="margin-right:5px;"></i>{{LoaderDict.Container.ChangePassword}}</el-dropdown-item>
                     <el-dropdown-item command="b">
                        <i class="fa fa-globe" style="margin-right:5px;"></i>{{LoaderDict.Container.LanguageSelection}}</el-dropdown-item>
                     <el-dropdown-item command="c">
                        <i class="fa fa-power-off" style="margin-right:5px;"></i>{{LoaderDict.Container.LogOut}}</el-dropdown-item>
                  </el-dropdown-menu>
               </el-dropdown>
            </el-col>
         </el-row>
      ...
      <vm-form-changepassword subscribe="System.ChangePassword"></vm-form-changepassword>
   </div>
</template>
...
Vue.component("vp-header-default", {
   ...
   methods: {
      ...
      handleCommand(command) {
         if(command=='a'){
            this.$Bus.$emit("System.ChangePassword")
         }
         else if(command=='b'){
            this.$Bus.$emit("System.ChangeLanguages")
         }
         else if(command=='c'){
            this.$confirm("此操作将退出，是否继续？",function(){
               console.log('exit')
            },function(){
               console.log('cancel')
            })
