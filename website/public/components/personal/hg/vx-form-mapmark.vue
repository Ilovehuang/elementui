<template>
   <div class="vx-form-mapmark">
      <label class="map-input">{{LoaderDict.Common.Longitude}}：</label>
      <div class="map-input">
         <vx-form-input :placeholder="LoaderDict.Common.Longitude" :label="LoaderDict.Common.Longitude" v-model="longitude" width="50px"></vx-form-input>
      </div>
      <label class="map-input">{{LoaderDict.Common.Latitude}}：</label>
      <div class="map-input">
         <vx-form-input :placeholder="LoaderDict.Common.Latitude" v-model="latitude" size="small"></vx-form-input>
      </div>
      <div class="map-input">
         <vx-basic-button type="search" @click="open" class="left" size="small"></vx-basic-button>
      </div>
      <vx-view-dialog :title="LoaderDict.Common.Prompt" :visible.sync="dialogVisible" :width="DialogWidth">
