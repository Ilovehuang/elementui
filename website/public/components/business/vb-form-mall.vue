<template>
   <vx-container-dialog :form="FormData" :rules="Rules" :title="LoaderDict.Business.T_Mall.Title" width="700" :visible.sync="Visible" :trigger.sync="SaveTrigger">
      ...
      <vx-container-item :label="LoaderDict.Business.T_PhysicalZone.CompanyId" :rule="Rules.CompanyId">
         <vb-select-company v-model="FormData.CompanyId" :placeholder="LoaderDict.Placeholder.PleaseInput + LoaderDict.Business.T_Company.CompanyId" :label.sync="FormData.CompanyName"></vb-select-company>
      </vx-container-item>
      ...
      <vx-container-item :label="LoaderDict.Business.T_Mall.Province" >
      ...
      <vx-container-item :label="LoaderDict.Business.T_Mall.TimeZone">
         <vx-item-select v-model="FormData.TimeZone" type="ShiQu" :placeholder="LoaderDict.Placeholder.PleaseInput + LoaderDict.Business.T_Mall.TimeZone"></vx-item-select>
      </vx-container-item>
      <vx-container-item :label="LoaderDict.Business.T_Mall.Rank">
         <vx-item-number v-model="FormData.Rank" :min="0" :placeholder="LoaderDict.Placeholder.PleaseInput + LoaderDict.Business.T_Mall.Rank"></vx-item-number>
      </vx-container-item>
