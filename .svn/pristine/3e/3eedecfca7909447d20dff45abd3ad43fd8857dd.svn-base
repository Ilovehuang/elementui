<template>
   <vx-basic-tree :options="List" labelfield="Name"  :defaultkeys="defaultkeys" valuefield="Id" :defaultprops="defaultProps" :showcheckbox="showcheckbox" :currentnode.sync="currentnode" v-model="result">
      <vd-system-location operate="load"   :trigger="trigger" :query="Query" method="tree" :result.sync="List"></vd-system-location>
   </vx-basic-tree>
