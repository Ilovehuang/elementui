      ...
      return {
         Options: {
            ...
            columns: [
               ...
               {
                  title: LoaderDict.Business.S_UserGroup.MallCount, //案场数量
                  width: 80,
                  className: "text-center",
                  data: function(row) {
                     var MallCount=0
                     if(row.MallIds)
                        MallCount = row.MallIds.length;
                     return MallCount;
                  }
               },
               {
                  ...
                  className: "text-center",
                  data: function(row) {
                     var plugin = "<a class='blue' vue-click='plugin'>"+LoaderDict.Business.RelatedMall+"</a> ";
