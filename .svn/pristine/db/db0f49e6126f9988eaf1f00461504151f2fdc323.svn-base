<template>
   <vx-view-datatable :options="Options" :checked="Checked" :tabledata="List" :rowdata.sync="RowData" :modifyrow.sync="ModifyForm" :deleterow.sync="DeleteTrigger">
      <vd-bd-device operate="load" :method="method" :autoload="autoload" :trigger.sync="LoadTrigger" :query="Query" :result.sync="List"></vd-bd-device>
      <!-- <vd-bd-device operate="save" method="del" :trigger.sync="DeleteTrigger" :query="RowData" :result.sync="DeleteResult"></vd-bd-device> -->
      <vb-bd-physicalunlinkeddevice operate="save" :method="physicalmethod" :trigger.sync="DeleteTrigger" :query="RowData" :result.sync="DeleteResult"></vb-bd-physicalunlinkeddevice>
...
$VueFactory.businessGrid({
   template: template,
   name: "vb-grid-unlinkeddevicezone",
   created() {
      var me = this;
      //默认不加载
      this.autoload = false;
      Event.$on("Grid.LinkedPhysicalZone", function(data) {
         if (data != undefined) {
       ...
       Event.$on("Grid.CheckedSave", function(data) {
         me.$set(me.Query, "Checked", me.Checked);
         Event.$emit("Grid.SaveUnLinkedPhysicalZone", me.Query);
         me.Checked = []
   ...
   GridOptions: {
      ...
      afterDraw(maingrid) {
         CheckCheckbox.drawradio(maingrid, [{"Id":"12a3f524e2ea445db5dda88d07db79e8"},{"Id":"16f60b9c4a4c4e33a440d8bcf3e9b1c8"}]);
      },
      cellClick(e, isChecked) {
         CheckCheckbox.cellClick(this, e, isChecked, [{"Id":"12a3f524e2ea445db5dda88d07db79e8"},{"Id":"16f60b9c4a4c4e33a440d8bcf3e9b1c8"}]);
      },
      CheckAll(e, maingrid, allChecked) {
         CheckCheckbox.CheckAll(e, maingrid, allChecked, [{"Id":"12a3f524e2ea445db5dda88d07db79e8"},{"Id":"16f60b9c4a4c4e33a440d8bcf3e9b1c8"}]);
      }
   }
});
</script>
